...
// // ユーザ存在有無確認
// $sql = 'SELECT COUNT(*) FROM lb_todo_table WHERE todoName=:todoName';
...
$sql = 'INSERT INTO lb_todo_table(id, todoText, todoDate, todoName) VALUES(NULL, :todoText, sysdate(), :todoName)';
